...
Tags: database, post, posts, order, ordering, sort, sorting, manually, scroll, drag and drop, drag, drop, infinite scroll
...
= Main Features =
Change the settings via: WP Admin Panel &raquo; Settings &raquo; Order Posts Options<br />
Start the plugin via: WP Admin Panel &raquo; Tools &raquo; Order Posts Manually<br />
...
* WP Admin Panel &raquo; Tools &raquo; Order Posts Manually.

= How do I change the options for this plugin? =
* WP Admin Panel &raquo; Settings &raquo; Order Posts Options.
