...
if ( ! class_exists( 'EasyBooking\Frontend_Assets' ) ) :
    ...
    **/
    private function get_frontend_parameters( $product ) {
        ...
        $frontend_parameters = array(
            ...
            'booking_duration'             => wceb_sanitize_parameters( $booking_settings['booking_duration'], 'esc_html' ),
            'booking_custom_duration'      => wceb_sanitize_parameters( $booking_settings['custom_booking_duration'], 'absint' ),
