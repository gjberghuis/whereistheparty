<div class="wceb-reports-filters">
	...
	<form id="bookings-filter" method="get">
		...
		<div class="reports-filter filter-date">
			...
			<input type="text" name="start_date" data-value="<?php esc_attr_e( $filter_start_date ); ?>" class="datepicker" placeholder="<?php echo isset( $start_date_text ) ? esc_attr( $start_date_text ) : esc_attr__( 'Start', 'woocommerce-easy-booking-system' ); ?>">

		</div>

		<div class="reports-filter filter-date">

			<input type="text" name="end_date" data-value="<?php esc_attr_e( $filter_end_date ); ?>" class="datepicker" placeholder="<?php echo isset( $end_date_text ) ? esc_attr( $end_date_text ) : esc_attr__( 'End', 'woocommerce-easy-booking-system' ); ?>">
