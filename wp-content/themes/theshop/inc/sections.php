...
if (!function_exists('theshop_products_section')) :
    /**
    ...
    function theshop_section_products()
    {
        ...
        $number = get_theme_mod('products_number', '6');
...
if (!function_exists('theshop_cta_section')) :
    /**
...
if (!function_exists('theshop_cats_section')) :
    /**
    ...
    function theshop_section_cats()
    {
        ...
        $number = get_theme_mod('cats_number', '6');
        ?>
...
if (!function_exists('theshop_posts_section')) :
    /**
     * WooCommerce categories loop
     *
     */
